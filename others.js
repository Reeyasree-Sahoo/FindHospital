/*document.addEventListener('DOMContentLoaded', function () {
    ...
    // Using the Places API to search for hospitals near a specific location (e.g., predefined coordinates).
    const request = {
      location: { lat: 20.324252706635974, lng: 85.81380454027315 }, // Adjusting the coordinates as needed
      radius: 5000, // Adjusting the radius as needed
      type: 'hospital',
    };
    ...
    service.nearbySearch(request, function (results, status) {
      if (status === google.maps.places.PlacesServiceStatus.OK) {
        ...
        resultsContainer.innerHTML = 'No hospitals found.';
      }
    });
  });*/


//corrected others.html
/*<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8">
